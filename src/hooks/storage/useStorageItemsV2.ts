...
export interface UseStorageItemsV2Return extends QueryReturn<StorageItem[]> {}

/**
 * ストレージアイテム一覧を取得・管理するフック（V2: subpathStrategy対応版）
 *
 ...
 */
export function useStorageItemsV2(
  identityId: string | null,
  currentPath: string,
): UseStorageItemsV2Return {
