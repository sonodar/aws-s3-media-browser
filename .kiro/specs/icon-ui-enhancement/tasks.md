...
- [ ] 2.1 StorageItem 型と parseStorageItems の拡張
...
- [ ] 4.1 (P) フォルダ作成・アップロード・閉じるボタンのアイコン実装
