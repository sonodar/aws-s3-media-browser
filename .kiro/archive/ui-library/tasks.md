...
- [x] 4. ContextMenu の Mantine Menu 移行

- [x] 4.1 ContextMenu を Mantine Menu ベースに書き換える
  ...
  - position 座標に基づいてメニューを配置する（仮想アンカー要素を使用）
  - _Requirements: 4, 7_
...
- [x] 4.4 ContextMenu の動作を検証する
  - 長押しでメニューが表示されることを確認する（PC/SP共通）
...
- [x] 5. Header の Burger + Menu 移行

- [x] 5.1 Header に Mantine Burger と Menu を実装する
