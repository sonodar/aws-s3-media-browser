...
describe("thumbnail handler utils", () => {
  ...
  describe("getThumbnailPath", () => {
    ...
    it("should handle nested paths", () => {
      expect(getThumbnailPath("media/abc123/folder/subfolder/image.png")).toBe(
        "thumbnails/abc123/folder/subfolder/image.png.thumb.jpg",
      );
    });

    it("should throw error for non-media paths", () => {
      expect(() => getThumbnailPath("other/path/image.jpg")).toThrow(
